...
class Login extends jigowatt_integration {
	...
	function __construct() {
		...
		if ( parent::getOption('signin-redirect-referrer-enable') )
			$_SESSION['intranet_clean']['referer'] = (!empty($_SESSION['intranet_clean']['referer'])) ? $_SESSION['intranet_clean']['referer'] : 'home.php';
		else
	...
	public function login() {
		...
		$_SESSION['intranet_clean']['name'] = $this->result['name'];
		$_SESSION['intranet_clean']['avatar'] = str_replace('assets/upload/avatar','assets/upload/avatar/thumb',$this->result['avatar']);
