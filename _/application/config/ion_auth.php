...
$config['tables']['users_level']     = 'users_level';
$config['tables']['users_info']      = 'user_info';
/*
...
$config['join']['users_info']  = 'user_level';
$config['join']['users_level'] = 'nr';
...
$config['default_id_level']        = '6'; 			// Default group, use name
$config['default_level']        = 'CONTRIBUTOR'; 			// Default group, use name
$config['default_id_group']        = '1'; 			// Default group, use name
$config['default_group']        = 'members'; 			// Default group, use name
$config['admin_group']          = array('ADMIN','SUPER ADMIN'); // Default administrators group, use name
