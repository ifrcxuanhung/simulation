            ...
            <div class="portlet-body background_portlet ">     
                <div class="table-scrollable">
                    <table class="table table_color table_cus table-bordered table-hover">
    					<thead>
    						<tr>
                                <th width="<?php echo 100/6 ?>%" class="th_custom"><h6 class="color_h6 cus_type"><?php translate('STRIKE_PRICE') ?></h6></th>
                                <th width="<?php echo 100/6 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('VAR') ?></h6></th>
                                <th width="<?php echo 100/6 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_1']))?>(<?php if (isset($K_1)) echo $K_1; ?>)</h6></th>
                                <th width="<?php echo 100/6 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_2']))?>(<?php if (isset($K_2)) echo $K_2; ?>)</h6></th>
                                <th width="<?php echo 100/6 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('COMBINE') ?></h6></th>
                                <th width="<?php echo 100/6 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('PERFORMANCE') ?></h6></th>
    						</tr>
    					</thead>
    					<tbody>
                            <?php
