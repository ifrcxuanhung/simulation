        	...
        	<div class="col-md-8">
                ...
                <div class="portlet box yellow">
    				...
    				<?php
						...
						$arr_cal = $this->mCalculate->Calculate_2($S, $K_1, $K_2, $R, $T, $Sigma, $Q, $data["intervalle"], $data['type_1'], $data['type_2'], $data['l/s_1'], $data['l/s_2'], $data['quantity_1'], $data['quantity_2']);
                           ...
                           if ($('#container').size() != 0) {
                            ...
                            $('#site_activities_content').show(); 
                                        ...
                                        events: {
                                            load: function(event){
                                               // this.series[0].setData(s_option);
												...
												this.series[2].setData(s_combinee);
												this.xAxis[0].setCategories(s_support);
                                                //alert(highchart_a);
    							...
    							<div id="site_activities_content" class="display-none">
    								<div id="container" style="min-width: 310px; height: 432px; margin: 0 auto"></div>
    							</div>
                            ...
                            <div class="col-md-12">    
                                <div class="table-scrollable">
                                    <table class="table table-striped table-bordered table-advance table-hover">
                    					<thead>
                    						<tr class="heading">
                                            	<th width="<?php echo 100/6 ?>%" style="color: #fff;"><strong><?php translate('STRIKE_PRICE') ?></strong></th>
                                                <th width="<?php echo 100/6 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('VAR') ?></strong></th>
                                                <th width="<?php echo 100/6 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_1']))?>(<?php if (isset($K_1)) echo $K_1; ?>)</strong></th>
                                                <th width="<?php echo 100/6 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_2']))?>(<?php if (isset($K_2)) echo $K_2; ?>)</strong></th>
                                                <th width="<?php echo 100/6 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('COMBINE') ?></strong></th>
                                                <th width="<?php echo 100/6 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('PERFORMANCE') ?></strong></th>
                    						</tr>
                    					</thead>
                    					<tbody>
                                            <?php
