                ...
                <form class="form-horizontal margin-bottom-10" method="post" onsubmit="return kiemtra();">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="bv" name="bv" type="text"  placeholder=translate"medium" class="form-control" disabled value="<?php echo round($bv,2); ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <table class="table table_color table_cus table-bordered table-hover">
    					...
    					<tbody>
							...
							<tr>
    							...
    							<td class="td_custom" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f", $arr_cal['vars'][$c]); ?></td>                                <td class="td_custom" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f", $arr_cal['net'][$c]); ?></td>
