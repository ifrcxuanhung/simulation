                          ...
                          $mmm = substr(strftime('%B',strtotime($market['expiry'])),0,3);
                            ...
                            <tr>
                             <td class="td_custom" align="left"><?php echo substr($market['utype'],0,3); ?> </td>
                                ...
                                <td class="td_custom" align="right"> <span class="<?php echo ($market['bid'] != NULL && $market['bid'] !='-')? 'bg_color_red': '';?> " id="option_contracts_bid_<?php echo $key;?>"><?php echo ($market['bid'] != NULL && $market['bid'] !='-') ? number_format($market['bid'],$get_decimal,'.',$get_comma):'';?></span> </td>
                                <td class="td_custom" align="left"> <span class="<?php echo ($market['ask'] != NULL && $market['ask'] !='-')? 'bg_color_green': '';?> " id="option_contracts_ask_<?php echo $key;?>"><?php echo ($market['ask'] != NULL && $market['ask'] !='-') ? number_format($market['ask'],$get_decimal,'.',$get_comma):'';?></span> </td>
