...
<div class="row">
	...
	<div class="col-md-8">
        ...
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption text-uppercase"><i class="icon-reorder"></i><?php translate("Options Strategies") ?></div>
            </div>
			<?php
				...
				$arr_cal = $this->mCalculate->Calculate_3($S, $K_1, $K_2, $K_3, $R, $T, $Sigma, $Q, $data["intervalle"], $data['type_1'],$data['type_2'],$data['type_3'],  $data['l/s_1'], $data['l/s_2'], $data['l/s_3'], $data['quantity_1'], $data['quantity_2'],  $data['quantity_3']);
    ...
    <div class="col-md-6">
        <div class="portlet box red">
            ...
            <div class="portlet-body background_portlet" style="min-height: 509px;">
                  <?php
                   $pattern =  "/^-?[0-9]+\,[0-9]+$/";
                                ...
                                events: {
                                    load: function(event){
                                       // this.series[0].setData(s_option);
										...
										this.series[3].setData(s_combinee);
										this.xAxis[0].setCategories(s_support);
                                        //alert(highchart_a);
                     ...
                     <table class="table table_color table_cus table-bordered table-hover table-full-width">
                        ...
                        <tbody>
                            <?php foreach($trategy_desc as $key => $value){ ?>
                                    <tr><td class="td_custom cus_pri bold"><strong><?php echo translate($key,true)?></strong></td><td class="td_custom"><?php echo $value ?></td></tr>
                            <?php } ?>
                        </tbody>
                     </table>
				</div>
            ...
            <div class="portlet-body background_portlet ">     
                <div class="table-scrollable">
                    <table class="table table_color table_cus table-bordered table-hover">
    					<thead>
    						<tr>
                            	<th width="<?php echo 100/7 ?>%" class="th_custom"><h6 class="color_h6 cus_type bold"><?php translate('STRIKE_PRICE') ?></h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('VAR') ?></h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_1']))?>(<?php if (isset($K_1)) echo $K_1; ?>)</h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_2']))?>(<?php if (isset($K_2)) echo $K_2; ?>)</h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_3']))?>(<?php if (isset($K_3)) echo $K_3; ?>)</h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('COMBINE') ?></h6></th>
                                <th width="<?php echo 100/7 ?>%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php translate('PERFORMANCE') ?></h6></th>
    						</tr>
    					</thead>
    					<tbody>
                            <?php
