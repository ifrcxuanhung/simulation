                        ...
                        <form class="form-horizontal margin-bottom-10" method="post" onsubmit="return kiemtra();">
                            <div class="col-md-6 margin-top-20">
                                ...
                                <div class="form-group <?php echo $data['type_1'] == 's' ? 'hidden' : ""?>">
                                    <label class="col-md-8 control-label bold"  ><?php translate('EXERCISE PRICE, K 1 =') ?></label>
                                    <div class="col-md-4" >
                                ...
                                <div class="form-group <?php echo $data['type_2'] == 's' ? 'hidden' : ""?>">
                                    <label class="col-md-8 control-label bold"  ><?php translate('EXERCISE PRICE, K 2 =') ?></label>
                                    <div class="col-md-4" >
                                ...
                                <div class="form-group <?php echo $data['type_3'] == 's' ? 'hidden' : ""?>">
                                    <label class="col-md-8 control-label bold"  ><?php translate('EXERCISE PRICE, K 3 =') ?></label>
                                    <div class="col-md-4" >
                                 ...
                                 <div class="form-group <?php echo $data['type_4'] == 's' ? 'hidden' : ""?>">
                                    <label class="col-md-8 control-label bold"  ><?php translate('EXERCISE PRICE, K 4 =') ?></label>
                                    <div class="col-md-4" >
                            ...
                            <div class="col-md-12">       
                                <div class="table-scrollable">
                                    <table class="table table-striped table-bordered table-advance table-hover">
                    					<thead>
                    						<tr class="heading">
                                            	<th width="<?php echo 100/8 ?>%" style="color: #fff;"><strong><?php translate('STRIKE_PRICE') ?></strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('VAR') ?></strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_1']))?>(<?php if (isset($K_1)) echo $K_1; ?>)</strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_2']))?>(<?php if (isset($K_2)) echo $K_2; ?>)</strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_3']))?>(<?php if (isset($K_3)) echo $K_3; ?>)</strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php strtoupper(translate($data['type_4']))?>(<?php if (isset($K_4)) echo $K_4; ?>)</strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('COMBINE') ?></strong></th>
                                                <th width="<?php echo 100/8 ?>%" style="text-align: right !important; color: #fff ;"><strong><?php translate('PERFORMANCE') ?></strong></th>
                    						</tr>
                    					</thead>
                    					<tbody>
                                            <?php
            								...
            								<tr>
            									...
            									<td class="highlight" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f",  $arr_cal['Pattes_1'][$c]); ?></td>
            									<td class="highlight" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f",  $arr_cal['Pattes_2'][$c]); ?></td>
                                                <td class="highlight" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f",  $arr_cal['Pattes_3'][$c]); ?></td>
                                                <td class="highlight" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f",  $arr_cal['Pattes_4'][$c]); ?></td>
            									<td class="highlight" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f", $arr_cal['combinee'][$c]); ?></td>
