        ...
        <div class="portlet box red blocks">
			...
			<?php
				...
				if (!isset($S)) {
                    ...
                    $M = 5;
                    $R = round($data["r(%)"],2);
                    $T1 = round($data["nb_of_date"]);
                    $T2 = round($data["nb_of_date2"]);
				...
				$arr_cal = $this->mCalculate->Calculate_F($S, $R, $T1, $Q,$M,$data['l/s_1']);
			?>
                ...
                <form class="form-horizontal margin-bottom-10" method="post" onsubmit="return kiemtra();">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="t1" name="t1" type="text"  placeholder="medium" class="form-control" value="<?php if (isset($T1)) echo $T1; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-7 control-label bold" ><?php translate('STRATEGY_MATURITY2') ?></label>
                            <div class="col-md-4">
                                <input id="t2" name="t2" type="text"  placeholder="medium" class="form-control" value="<?php if (isset($T2)) echo $T2; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php
                           function Ftheo($LS, $LR, $LT, $LQ) {
                            ...
                            $RR = $R / 100;
                            $QQ = $Q / 100;
                            $fv1 = Ftheo($S, $RR, $T1, $QQ);
                            $fv2 = Ftheo($S, $RR, $T2, $QQ);
                            $fv = $fv1 + $fv2; 
                            $bv = $fv - $S;
                            $mv = $S * $MM;
                        ?>
                 ...
                 <script type="text/javascript" language="javascript">
					function kiemtra(){
                        ...
                        tv1 = document.getElementById('t1').value.length;
                        
                        t2 = document.getElementById('t2').value;
                        tv2 = document.getElementById('t2').value.length;
                        ...
                        for(var tl1 = 0;tl1<tv1;tl1++)
                        {
                            if(digit.indexOf(t1.substr(tl1,1)) == -1)
                            {
                        ...
                        for(var tl2 = 0;tl2<tv2;tl2++)
                        {
                            if(digit.indexOf(t2.substr(tl2,1)) == -1)
                            {
