                ...
                <div class="table-responsive">
                    <table class="table  table-bordered">
						...
						// calculation
                            ...
                            <tr>
                                <td colspan="2" class="td_custom font_size_new" align="center"><div class="col-md-12"><a class="btn btn-lg blue form-control btn_order_session" style="min-height: 40px;" href="<?php base_url() ?>futures_live"><strong><?php translate('btn_order'); ?></strong></a></div></td>
                            </tr>
