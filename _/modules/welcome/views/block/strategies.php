 <div class="portlet box red blocks" style="margin-bottom:5px; position:relative;">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa"></i><?php translate('head_box_technical_analysis'); ?></div>
            <div class="tools">
    ...
    <div class="portlet-body background_portlet">
        <div class="table-responsive">
            <table class="table table-bordered table-hover table_cus">
                <thead>
                    <tr>
                        <th class="th_custom" id="edu_des"style="text-align:left"><h6 class="color_h6 cus_type"> Name </h6></th>
                        <th class="th_custom" id="edu_title"><h6 class="color_h6 cus_type"> More</h6> </th>
                    </tr>
                </thead>
                <tbody>
