 <div class="portlet box red blocks" style="margin-bottom:5px;">
    <div class="portlet-title header-table" style="position:relative;">
        <div class="caption  text-uppercase">
            <i class="fa"></i><?php translate('head_box_futures_strategies') ?></div>
         <div class="tools">
    ...
    <!--div class="search_strategies_futures"><input type="name" placeholder="Search..." name="query" class="form-control input-small"></div-->
    <div class="portlet-body background_portlet">
        <div class="table-responsive">
            <table class="table table-bordered table-hover table_cus">
                ...
                <tbody>
                 <?php foreach($array['futures'] as $value){ ?>
                    <tr>
...
<div class="portlet box red" style="margin-bottom:5px;">
