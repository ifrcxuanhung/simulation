    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="table-group-actions pull-right">
				<a class="btn btn-sm blue add-modal add-articles-order" href="<?php echo base_url() ?>ajax/add_modal_vnxindex/" keys="" table_name="<?php echo $table; ?>">
				    <i class="fa fa-plus"></i> Add </a>
              <!--  <button class="btn btn-sm blue add-modal" keys="" table_name="<?php echo $table; ?>" type="submit"><i class="fa fa-plus"></i>Add</button> -->   
