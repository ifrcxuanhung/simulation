                                            ...
                                            ?>" alt=""/>
                                                    ...
                                                    <div>
                                                       ...
                                                       <!-- <span class="fileinput-new">
                                                        ...
                                                        <a href="javascript:;" class="btn red delete_image fileinput-exists tooltips" data-dismiss="fileinput" data-original-title="Delete"><i class="fa fa-remove"></i>
                                                       </a>
                                                    </div>
                                                </div>
                                            ...
                                            <img id="img" src="" alt="" />
                                                    ...
                                                    <div>
                                                       ...
                                                       <!-- <span class="fileinput-new">
                                                        ...
                                                        <a href="javascript:;" class="btn red delete_file_intranet tooltips" data-dismiss="fileinput" data-original-title="Delete"><i class="fa fa-remove"></i>
                                                       </a>
                     ...
                     <div class="portlet-tabs">
                        ...
                        <div class="form-actions right">
									...
									<button class="btn blue submit_article" type="submit" value="ok" id="save_article" name="ok">Save changes</button>
                                     <a class="btn red sub-apso2" href="<?php echo base_url();?>table/ifrc_articles/?<?php echo $get_filter;?>">Close</a>
                                   <a class="btn red" href="<?php echo base_url();?>table/ifrc_articles/?<?php echo $get_filter;?>">Close</a>
								</div> 
