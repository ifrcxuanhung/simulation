                ...
                <form class="form-horizontal margin-bottom-10" method="post" onsubmit="return kiemtra();">
                    <div class="form-body">
                        ...
                        <div class="form-group <?php echo $data['type_1'] == 's' ? 'hidden' : ""?>">
                            <label class="col-md-7 control-label bold"  ><?php translate('STRATEGY_EXERCISE_PRICE') ?></label>
                            <div class="col-md-4" >
                    ...
                    <table class="table table_color table_cus table-bordered table-hover">
    					<thead>
    						<tr>
                                <tr>
                                    ...
                                    <th width="20%" class="th_custom align-right"><h6 class="color_h6 cus_type"><?php strtoupper(translate($data['type_1']))?>(<?php if (isset($K)) echo $K; ?>)</h6></th>
    					...
    					<tbody>
							...
							<tr>
                                ...
                                <td class="td_custom" style="text-align: right !important;border-left-width: 1px;"><?php printf("%10.2f", $data['quantity_1'] * $arr_cal['Options'][$c]); ?></td>
