...
class category_model extends CI_Model {
    ...
    // Lấy luôn parent
    function list_category_code_fixx($parentCode = NULL, $stop = "", $data = null, $space = "") {
        if ($parentCode != NULL)
            $parentCode = " AND c.category_code = '" . $parentCode . "'";
...
// get description
    ...
    public function get_cateid_by_codecate($code){
        $sql = "SELECT category.`category_id`
                FROM category
                WHERE category.category_code = '{$code}' LIMIT 1";
