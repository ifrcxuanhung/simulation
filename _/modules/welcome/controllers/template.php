...
/*
  ...
  |
 */
$template['active_template'] = 'simulation';
...
$template['simulation']['template'] = 'simulation/template.php';
$template['simulation']['path'] = 'assets/templates/simulation/';
$template['simulation']['regions'] = array(
    'header',
    'content'    
);

$template['simulation']['parser'] = 'parser';
$template['simulation']['parser_method'] = 'parse';
$template['simulation']['parse_template'] = FALSE;
