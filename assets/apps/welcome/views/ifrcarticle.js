define([
    ...
    'backbone'
        ...
        var ifrcarticleView = Backbone.View.extend({
            el: $(".main-container"),
            initialize: function() {
                   ...
                   var grid = new Datatable();
                        grid.init({
                            ...
                            dataTable: {
                                ...
                                "pageLength": 10,
                                "ajax": {
                                    "url": $base_url + "ifrcarticle/loadifrcarticle/?name_table=" +name_table+"&category="+category+'&'+value_filter,
                                    "type": "POST"
                                },
