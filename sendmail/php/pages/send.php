...
if ($_REQUEST['process']) {
    ...
    <html>
        ...
        <body>
			...
			echo "<script>$('#status_send',window.parent.document).html('Complete !');</script>";
			$send_data = $newsletter->get_send($db, $send_id);
    ...
    <?php } else {
        ...
        ?>
            ...
            if ($send_data['status'] == '3') {
                ...
                <div id="status_send" style="font-size:20px; padding:20px;"> Complete!</div>

            <?php } else { ?>

                <?php if ($send_data['status'] == '6') { ?>

                    <div id="status_send" style="font-size:20px; padding:20px;"> Paused...</div>

                <?php } else { ?>

                    <div id="status_send" style="font-size:20px; padding:20px;"> Sending...</div>
